...
//home screen
const HEADER_IMAGE = `<i class="fas fa-flask fa-5x" alt="flask icon"></i>`;
...
const FINAL_IMAGE = `<i class="fas fa-glass-cheers fa-10x" alt="champagne icon"></i>`;
...
const QUESTIONS_AND_ANSWERS = [
    {question: "Which of the following is a step in the scientific method?", icon: `<i class="fas fa-5x fa-clipboard-list" alt="clipboard icon"></i>`,
...
the results aiming to support or contradict a theory" (<a href="https://www.livescience.com/20896-science-scientific-method.html" target="_blank">source</a>).</p>`},
    {question: "Name one of the main rock classifications.", icon: `<i class="fas fa-globe-africa fa-5x" alt="globe icon"></i>`,
    ...
    {question: "Which of the following are carbohydrates?", icon: `<i class="fas fa-bread-slice fa-5x" alt="bread icon"></i>`,
    ...
    {question: "What is photosynthesis?", icon: `<i class="fas fa-leaf fa-5x" alt="leaf icon"></i>`,
    ...
    {question: "Which organ is responsible for detoxifying chemicals?", icon: `<i class="fas fa-child fa-5x" alt="human body icon"></i>`,
    ...
    {question: "Which elements are in the chemical formula H2O?", icon: `<i class="fas fa-atom fa-5x" alt="atom icon"></i>`,
    ...
    {question: "In physics, which form of energy describes an object in motion?", icon: `<i class="fas fa-rocket fa-5x" alt="rocket icon"></i>`,
    ...
    {question: "Which is NOT a result of deforestation?", icon: `<i class="fas fa-tree fa-5x alt="tree icon""></i>`,
    ...
    {question: "Which of the following are lab safety rules you'll find in a chemistry lab?", icon: `<i class="fas fa-eye-dropper fa-5x" alt="dropper icon"></i>`,
    ...
    {question: "Which of the following would be the most basic pH?", icon: `<i class="fas fa-vials fa-5x" alt="icon of two vials"></i>`,
